...
jest.mock('../../../../../src/core/server/saved_objects/migrations/opensearch_dashboards/opensearch_dashboards_migrator', () => ({
  mergeTypes: jest.fn(() => ({})),
}));

describe('migrateTenantIndices', () => {
  const tenants = ['.kibana_1234_alice', '.kibana_5678_bob', '.kibana_9012_carol'];
  const migrationsCore = require('../../../../../src/core/server/saved_objects/migrations/core');
  const { migrateTenantIndices } = require('../tenant_index');
